...
userRoutes.post("/subscribe", notificationController.subscribeToPush);

// Se désabonner des notifications push
userRoutes.post("/unsubscribe", notificationController.unsubscribeFromPush);
...
router.get(
	"/admin/performance",
	adminAuthController.protect,
	notificationController.getPerformanceStats
);
...
router.post(
	"/admin/promotion",
	adminAuthController.protect,
	notificationController.notifyPromotion
);

// S'abonner aux notifications push (Admin)
router.post(
	"/admin/subscribe",
	adminAuthController.protect,
...
// Se désabonner des notifications push (Admin)
router.post(
	"/admin/unsubscribe",
	adminAuthController.protect,
...
router.post(
	"/admin/webhook/:provider",
	adminAuthController.protect,
	notificationController.handleNotificationWebhook
);
