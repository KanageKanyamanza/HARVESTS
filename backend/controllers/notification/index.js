...
module.exports = {
  ...
  getNotificationsByCategory: notificationUserController.getNotificationsByCategory,
  ...
  getNotificationPreferences: notificationUserController.getNotificationPreferences,
  updateNotificationPreferences: notificationUserController.updateNotificationPreferences,
  
  // Admin routes
  createSystemNotification: notificationAdminController.createSystemNotification,
  ...
  cleanupExpiredNotifications: notificationAdminController.cleanupExpiredNotifications,
  processScheduledNotifications: notificationAdminController.processScheduledNotifications,
  ...
  notifyProductPendingApproval: notificationSystemController.notifyProductPendingApproval,
  ...
  // Webhooks
  handleNotificationWebhook: notificationWebhookController.handleNotificationWebhook
};
