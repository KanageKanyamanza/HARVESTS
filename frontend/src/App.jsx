...
// Consumer Dashboard
const ProfileConsumer = React.lazy(() =>
	import("./pages/dashboard/consumer/ProfileConsumer")
);
const SettingsConsumer = React.lazy(() =>
	import("./pages/dashboard/consumer/SettingsConsumer")
);
const Favorites = React.lazy(() =>
	import("./pages/dashboard/consumer/Favorites")
);
const Subscriptions = React.lazy(() =>
	import("./pages/dashboard/consumer/Subscriptions")
);
const Reviews = React.lazy(() => import("./pages/dashboard/consumer/Reviews"));
const WriteReview = React.lazy(() =>
	import("./pages/dashboard/consumer/WriteReview")
);
...
// Producer Dashboard
const ProfileProducer = React.lazy(() =>
	import("./pages/dashboard/producer/ProfileProducer")
);
const SettingsProducer = React.lazy(() =>
	import("./pages/dashboard/producer/SettingsProducer")
);
const ProducerDashboard = React.lazy(() =>
	import("./pages/dashboard/producer/ProducerDashboard")
);
...
const Certifications = React.lazy(() =>
	import("./pages/dashboard/producer/Certifications")
);
const Transporters = React.lazy(() =>
	import("./pages/dashboard/producer/Transporters")
);
const Documents = React.lazy(() =>
	import("./pages/dashboard/producer/Documents")
);

// Transformer Dashboard
const TransformerDashboard = React.lazy(() =>
	import("./pages/dashboard/transformer/TransformerDashboard")
);

// Transformer Pages
const OrdersList = React.lazy(() =>
	import("./pages/dashboard/transformer/orders/OrdersList")
);
...
const CertificationsList = React.lazy(() =>
	import("./pages/dashboard/transformer/certifications/CertificationsList")
);
const BusinessAnalytics = React.lazy(() =>
	import("./pages/dashboard/transformer/analytics/BusinessAnalytics")
);
const ProfileSettings = React.lazy(() =>
	import("./pages/dashboard/transformer/ProfileTransformer")
);
const Settings = React.lazy(() =>
	import("./pages/dashboard/transformer/SettingsTransformer")
);
const ShopManagement = React.lazy(() =>
	import("./pages/dashboard/transformer/shop/ShopManagement")
);

// Restaurateur Dashboard
const RestaurateurDashboard = React.lazy(() =>
	import("./pages/dashboard/restaurateur/RestaurateurDashboard")
);
...
const RestaurateurProfile = React.lazy(() =>
	import("./pages/dashboard/restaurateur/ProfileRestaurateur")
);
const SettingsRestaurateur = React.lazy(() =>
	import("./pages/dashboard/restaurateur/SettingsRestaurateur")
);
...
const ConsumerDashboard = React.lazy(() =>
	import("./pages/dashboard/consumer/ConsumerDashboard")
);
									...
									<UserTypeRedirect>
										<Suspense fallback={<RouteFallback />}>
											<Routes>
												...
												<Route
													path="/transformer/certifications"
													element={
														<ProtectedRoute>
															<CertificationsList />
														</ProtectedRoute>
												...
												<Route
													path="/transformer/analytics/business"
													element={
														<ProtectedRoute>
															<BusinessAnalytics />
														</ProtectedRoute>
