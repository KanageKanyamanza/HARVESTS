...
const SuppliersList = () => {
  ...
  const filteredSuppliers = suppliers.filter(supplier => {
    const matchesSearch = !filters.search || 
      supplier.firstName?.toLowerCase().includes(filters.search.toLowerCase()) ||
    ...
    const matchesUserType = !filters.userType || supplier.userType === filters.userType;
    const matchesRegion = !filters.region || supplier.address?.region === filters.region;
    const matchesRating = !filters.rating || (supplier.rating && supplier.rating >= parseInt(filters.rating));
      ...
      <div className="p-6 max-w-7xl mx-auto pb-20">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-600 mt-1">Découvrez et gérez vos fournisseurs</p>
          </div>
          <Link
        ...
        {filteredSuppliers.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="mt-1 text-sm text-gray-500">
              {filters.search || filters.userType || filters.rating ? 'Aucun fournisseur ne correspond à vos critères' : 'Aucun fournisseur disponible pour le moment'}
            </p>
          </div>
        ) : (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {filteredSuppliers.map((supplier) => {
              ...
              return (
                <div key={supplier._id} className="bg-white rounded-lg shadow hover:shadow-md transition-shadow">
                  <div className="p-6">
                    <div className="flex items-center space-x-4 mb-4">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-sm text-gray-500 truncate">
                          {supplier.companyName || getUserTypeLabel(supplier.userType)}
                        </p>
                      </div>
                    </div>
        ...
        {pagination.totalPages > 1 && (
          <div className="mt-8 flex items-center justify-between">
            <div className="text-sm text-gray-700">
              Affichage de {((pagination.page - 1) * pagination.limit) + 1} à {Math.min(pagination.page * pagination.limit, pagination.total)} sur {pagination.total} fournisseurs
            </div>
            <div className="flex space-x-2">
              <button
