...
const NewOrder = () => {
	...
	const { cart, addToCart, removeFromCart, updateQuantity, calculateTotal } =
		useOrderCart();
	const { suppliers, selectedSupplier, setSelectedSupplier } =
		useOrderSuppliers();
		...
		<div className="p-6 max-w-7xl mx-auto pb-20">
			...
			<div className="mb-8">
				...
				<p className="text-gray-600 mt-1">
					Créez une nouvelle commande d'approvisionnement
				</p>
			</div>
			...
			{step === 3 && (
				<DeliveryForm order={order} onInputChange={handleInputChange} />
			)}
