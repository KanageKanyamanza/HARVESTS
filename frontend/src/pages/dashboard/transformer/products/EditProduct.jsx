...
import ProductBasicInfoTransformer from '../../../../components/products/ProductBasicInfoTransformer';
import ProductPricingStockTransformer from '../../../../components/products/ProductPricingStockTransformer';
    ...
    <ModularDashboardLayout userType="transformer">
      <div className="p-6 max-w-4xl mx-auto pb-20">
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          {/* Prix et stock */}
          <ProductPricingStockTransformer
            formData={formData}
            errors={errors}
            onInputChange={handleInputChange}
          />
