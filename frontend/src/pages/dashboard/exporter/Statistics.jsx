...
const Statistics = () => {
  ...
  return (
    <ModularDashboardLayout>
      <div className="p-6 max-w-7xl mx-auto">
        <div className="mb-8">
          <h1 className="text-2xl font-bold text-gray-900">Statistiques d'export</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <div className="bg-white rounded-lg shadow p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-gray-600">Exportations totales</p>
            ...
            <div className="bg-white rounded-lg shadow p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900 mt-2">
                    {stats.totalValue ? new Intl.NumberFormat('fr-FR', {
                      style: 'currency',
                      currency: 'XOF'
                    }).format(stats.totalValue) : '0 XOF'}
                  </p>
                </div>
        ...
        {!stats && (
          <div className="bg-white rounded-lg shadow p-12 text-center">
            ...
            <p className="mt-2 text-gray-600">
              Vos statistiques apparaîtront ici une fois que vous commencerez à exporter.
            </p>
          </div>
        )}
      </div>
