						...
						<div className="flex flex-col md:flex-row md:items-end justify-between gap-3">
							<div>
								...
								<p className="text-xs font-medium text-gray-500">
									Ajoutez une nouvelle référence à votre catalogue et commencez
									à vendre.
								</p>
							</div>
						</div>
							...
							<div className="space-y-4 animate-fade-in-up delay-200">
								...
								<div className="bg-blue-50/50 rounded-2xl p-4 border border-blue-100 flex gap-3">
									...
									<p className="text-xs text-blue-700 leading-relaxed font-medium">
										...
										<span className="font-bold">Brouillon</span>. Vous pourrez
										le publier pour validation par nos équipes depuis votre
										catalogue.
									</p>
								</div>
