								...
								<div className="flex flex-col md:flex-row gap-8 relative z-10">
									...
									<div className="flex-1 space-y-6">
										...
										:	<button
												...
												className="w-full py-4 border-2 border-dashed border-gray-200 rounded-[1.8rem] text-gray-600 hover:border-emerald-300 hover:text-emerald-500 hover:bg-emerald-50/50 transition-all font-black text-[10px] uppercase tracking-[0.3em] flex items-center justify-center gap-3 group"
											>
