...
import { ProfileHeader, VerificationStatus, ShopSection } from '../../../components/profile';
import ProfileFormFields from '../../../components/profile/ProfileFormFields';
import { useVendorStats, useVerificationStatus } from '../../../hooks/useProfileData';
import { FiUser } from 'react-icons/fi';
import commonService from '../../../services/commonService';
import { producerService, transformerService, restaurateurService, exporterService, transporterService } from '../../../services';
...
const ProfilePage = () => {
  ...
  const handleSave = async () => {
    try {
      ...
      if (user?.userType === 'restaurateur') {
        ...
        response = await transporterService.updateProfile({ ...formData, serviceAreas: formData.serviceAreas || [] });
      } else {
      ...
      alert(error.response?.data?.message || 'Erreur lors de la sauvegarde du profil');
    } finally {
      setSaving(false);
    }
  };
  ...
  const handleImageChange = async (type, imageUrl) => {
    const setters = { banner: setShopBanner, logo: setShopLogo, avatar: setAvatar };
