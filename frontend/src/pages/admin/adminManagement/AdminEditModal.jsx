			...
			<div className="bg-white/95 backdrop-blur-2xl rounded-[3rem] shadow-[0_32px_64px_-12px_rgba(0,0,0,0.14)] max-w-2xl w-full max-h-[90vh] overflow-hidden flex flex-col border border-white/40">
				<div className="p-5 flex-col overflow-y-auto">
					...
					<form onSubmit={onSubmit} className="space-y-4">
						<div className="grid grid-cols-2 gap-6">
							...
							<div className="space-y-3">
								...
								<input
									...
									className="w-full px-6 py-4 bg-gray-200/50 border border-transparent focus:border-indigo-100 focus:bg-white focus:ring-4 focus:ring-indigo-500/5 rounded-2xl transition-all duration-300 font-bold text-gray-900 placeholder:text-gray-300"
								/>
							</div>
						</div>
						...
						<div className="grid grid-cols-[100px_1fr] gap-6 items-center">
							...
							<div className="space-y-3">
								...
								<input
									...
									className="w-full px-6 py-4 bg-gray-50/50 border border-transparent focus:border-indigo-100 focus:bg-white focus:ring-4 focus:ring-indigo-500/5 rounded-2xl transition-all duration-300 font-bold text-gray-900 placeholder:text-gray-300"
						...
						<div className="space-y-3">
							...
							<div className="relative group/pass">
								<input
									...
									className="w-full px-6 py-4 bg-gray-200/50 border border-transparent focus:border-indigo-100 focus:bg-white focus:ring-4 focus:ring-indigo-500/5 rounded-2xl transition-all duration-300 font-bold text-gray-900 placeholder:text-gray-300 pr-14"
						...
						<div className="grid grid-cols-2 gap-6">
							<div className="space-y-3">
								...
								<select
									...
									className="w-full px-6 py-4 bg-gray-200/50 border border-transparent focus:border-indigo-100 focus:bg-white focus:ring-4 focus:ring-indigo-500/5 rounded-2xl transition-all duration-300 font-bold text-gray-900 appearance-none cursor-pointer"
								>
						...
						<div className="flex items-center space-x-3 p-4 bg-gray-50/50 rounded-2xl border border-transparent hover:border-indigo-100 transition-all cursor-pointer group/check">
							<div className="relative flex items-center">
								<input
									...
									className="w-6 h-6 border-2 border-gray-200 rounded-lg bg-white checked:bg-indigo-600 checked:border-indigo-600 transition-all duration-300 cursor-pointer appearance-none"
								/>
								<UserCheck
						...
						<div className="flex justify-end space-x-4 pt-6 border-t border-gray-100/50">
							...
							<button
								type="submit"
								disabled={saving}
								className="flex items-center px-10 py-4 bg-gray-900 text-white rounded-[2rem] font-black text-[10px] uppercase tracking-widest hover:bg-indigo-600 transition-all duration-500 shadow-xl hover:shadow-indigo-200/50 disabled:opacity-50"
							>
