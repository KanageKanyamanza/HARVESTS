    ...
    return (
      <div className="min-h-screen bg-harvests-light flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-6">{error || 'Ce plat n\'existe pas ou n\'est plus disponible.'}</p>
          <button 
            onClick={() => navigate('/')}
                ...
                <div className="space-y-3">
                  <div className="flex items-center">
                    ...
                    <span className="text-gray-900">
                      {restaurateur.restaurantName || `${restaurateur.firstName} ${restaurateur.lastName}`}
                    </span>
                  </div>
                  {restaurateur.city && (
                    <div className="flex items-center">
                  ...
                  {restaurateur.phone && (
                    <div className="flex items-center">
                      ...
                      <span className="text-gray-600">{restaurateur.phone}</span>
                    </div>
                  )}
                  {restaurateur.email && (
                    <div className="flex items-center">
                      <FiMail className="mr-3 text-gray-400" />
                      <span className="text-gray-600">{restaurateur.email}</span>
                    </div>
                  )}
                </div>
              </div>
