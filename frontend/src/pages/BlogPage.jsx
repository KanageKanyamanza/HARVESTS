					...
					<div className="flex flex-col md:flex-row gap-4">
						...
						>
							...
							<option value="article">
								{t("blog.types.article", "Article")}
							</option>
							<option value="etude-cas">
								{t("blog.types.etude-cas", "Étude de cas")}
							</option>
							<option value="tutoriel">
								{t("blog.types.tutoriel", "Tutoriel")}
							</option>
							<option value="actualite">
								{t("blog.types.actualite", "Actualité")}
							</option>
							<option value="temoignage">
								{t("blog.types.temoignage", "Témoignage")}
							</option>
						</select>
						...
						>
							<option value="">
								{t("blog.categories.all", "Toutes les catégories")}
							</option>
							<option value="strategie">
								{t("blog.categories.strategie", "Stratégie")}
							</option>
							<option value="technologie">
								{t("blog.categories.technologie", "Technologie")}
							</option>
							<option value="finance">
								{t("blog.categories.finance", "Finance")}
							</option>
							...
							<option value="operations">
								{t("blog.categories.operations", "Opérations")}
							</option>
							<option value="gouvernance">
								{t("blog.categories.gouvernance", "Gouvernance")}
							</option>
						</select>
					</div>
				</div>
				...
				{error ? (
					...
					<>
						<section
							...
							aria-label="Liste des articles de blog"
						>
							{blogs.map((blog) => (
								<article
									key={blog._id}
										...
										<div className="h-48 overflow-hidden">
											<CloudinaryImage
												...
												alt={
													...
													getLocalizedContent(blog.title, "Image du blog")
												}
