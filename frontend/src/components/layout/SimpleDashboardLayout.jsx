...
const SimpleDashboardLayout = ({ children }) => {
  ...
  const { userTypeInfo, displayLabel, displayIcon } = useUserType();
        ...
        <div className="flex flex-col w-64 bg-white shadow-lg">
          ...
          <div className="flex items-center h-16 px-4 border-b border-gray-200">
            <Link to="/" className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold text-harvests-green">Harvests</span>
            </Link>
          </div>
        ...
        <>
          ...
          <div className="fixed inset-y-0 left-0 z-50 w-64 bg-white shadow-lg lg:hidden">
            <div className="flex flex-col h-full">
              ...
              {/* Navigation mobile (même contenu que desktop) */}
