	...
	const socialNetworks = [
		{
			...
			url:
				links.instagram ||
				"https://www.instagram.com/ubb1957_?igsh=MW8xdDlsMGRzM2Jidg==",
			color: "#E4405F",
			hoverColor: "#D62D51",
		},
		{
			...
			url:
				links.linkedin ||
				"https://www.linkedin.com/in/ubuntu-business-builders-113223363?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app",
			color: "#0A66C2",
			hoverColor: "#004182",
		},
		{
			...
			icon: FaTiktok,
			url:
				links.tiktok || "https://www.tiktok.com/@ubb545?_t=ZN-8vKxXkXQe4g&_r=1",
			color: "#000000",
			hoverColor: "#333333",
		},
		{
			...
			url:
				links.youtube ||
				"https://youtube.com/@ubuntubusinessbuilders?si=NL3IMhyHoM06UCC2",
			color: "#FF0000",
			hoverColor: "#CC0000",
		},
	];
