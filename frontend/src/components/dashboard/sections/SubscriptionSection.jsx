...
import { FiStar, FiCalendar, FiDollarSign, FiCheckCircle, FiAlertCircle, FiXCircle, FiClock } from 'react-icons/fi';
...
const SubscriptionSection = () => {
  ...
  return (
    <div className="bg-white rounded-lg shadow p-6">
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-lg font-semibold text-gray-900 flex items-center">
          <FiStar className={`h-5 w-5 mr-2 ${getPlanColor(subscription.planId)}`} />
          Mon Abonnement
        </h3>
      ...
      <div className="space-y-4">
        <div>
          <div className="flex items-center justify-between mb-2">
            ...
            <span className={`text-lg font-bold ${getPlanColor(subscription.planId)}`}>
