		...
		growthStages: [
			{
				...
				name: "Pépinière & Semis",
				period: "Jours 1 à 30",
				image: "/images/chou/stage_semis.png",
				fallbackUrl: "https://images.unsplash.com/photo-1598170845058-12db4576905b?auto=format&fit=crop&w=800&q=80",
				description: "Semis en pépinière ombragée, germination des graines et développement des jeunes plants de chou avant repiquage.",
			},
			{
				id: "croissance",
				phase: "Étape 2",
				name: "Repiquage & Croissance Végétative",
				period: "Jours 30 à 60",
				image: "/images/chou/stage_croissance.png",
				fallbackUrl: "https://images.unsplash.com/photo-1500382017468-9049fed747ef?auto=format&fit=crop&w=800&q=80",
				description: "Repiquage au champ, développement du feuillage, sarclage et apport d'azote pour soutenir la croissance.",
			},
			{
				id: "floraison",
				phase: "Étape 3",
				...
				period: "Jours 60 à 90",
				image: "/images/chou/stage_floraison.png",
				fallbackUrl: "https://images.unsplash.com/photo-1464226184884-fa280b87c399?auto=format&fit=crop&w=800&q=80",
				description: "Serrage progressif des feuilles pour former la pomme, stade critique nécessitant un arrosage régulier et abondant.",
			},
			{
				id: "recolte",
				phase: "Étape 4",
				name: "Maturité & Récolte",
				period: "Jours 90 à 100",
				image: "/images/chou/stage_recolte.png",
				fallbackUrl: "https://images.unsplash.com/photo-1598170845058-12db4576905b?auto=format&fit=crop&w=800&q=80",
				description: "Récolte des pommes fermes et compactes, coupées à la base et triées avant transport à l'ombre.",
			},
		],
	},
	{
		...
		growthStages: [
			{
				...
				name: "Semis Direct",
				period: "Jours 1 à 20",
				image: "/images/carotte/stage_semis.png",
				fallbackUrl: "https://images.unsplash.com/photo-1447175008436-08417142ea96?auto=format&fit=crop&w=800&q=80",
				description: "Semis direct en place sur sol meuble et sans cailloux, germination lente nécessitant un arrosage léger et régulier.",
			},
			{
				id: "croissance",
				phase: "Étape 2",
				name: "Éclaircissage & Croissance",
				period: "Jours 20 à 45",
				image: "/images/carotte/stage_croissance.png",
				fallbackUrl: "https://images.unsplash.com/photo-1500382017468-9049fed747ef?auto=format&fit=crop&w=800&q=80",
				description: "Éclaircissage des jeunes plants pour éviter les racines déformées, désherbage régulier du feuillage naissant.",
			},
			{
				id: "floraison",
				phase: "Étape 3",
				name: "Grossissement des Racines",
				period: "Jours 45 à 70",
				image: "/images/carotte/stage_floraison.png",
				fallbackUrl: "https://images.unsplash.com/photo-1464226184884-fa280b87c399?auto=format&fit=crop&w=800&q=80",
				description: "Développement en profondeur des racines sous un feuillage dense, arrosage constant sans excès d'azote.",
			},
			{
				id: "recolte",
				phase: "Étape 4",
				name: "Maturité & Récolte",
				period: "Jours 70 à 90",
				image: "/images/carotte/stage_recolte.png",
				fallbackUrl: "https://images.unsplash.com/photo-1447175008436-08417142ea96?auto=format&fit=crop&w=800&q=80",
				description: "Arrachage des racines à taille souhaitée avant qu'elles ne deviennent fibreuses, fanes coupées et racines conservées au frais.",
			},
		],
	},
	{
		...
		growthStages: [
			{
				...
				name: "Semis Direct",
				period: "Jours 1 à 15",
				image: "/images/haricotvert/stage_semis.png",
				fallbackUrl: "https://images.unsplash.com/photo-1567375698348-5d9d5ae99de0?auto=format&fit=crop&w=800&q=80",
				description: "Semis direct en poquets sur sol léger et bien drainé, germination rapide des jeunes pousses.",
			},
			{
				id: "croissance",
				phase: "Étape 2",
				name: "Croissance & Tuteurage",
				period: "Jours 15 à 35",
				image: "/images/haricotvert/stage_croissance.png",
				fallbackUrl: "https://images.unsplash.com/photo-1500382017468-9049fed747ef?auto=format&fit=crop&w=800&q=80",
				description: "Développement du feuillage, pose des tuteurs pour les variétés grimpantes et désherbage régulier.",
			},
			{
				id: "floraison",
				phase: "Étape 3",
				name: "Floraison & Formation des Gousses",
				period: "Jours 35 à 50",
				image: "/images/haricotvert/stage_floraison.png",
				fallbackUrl: "https://images.unsplash.com/photo-1464226184884-fa280b87c399?auto=format&fit=crop&w=800&q=80",
				description: "Floraison suivie de la nouaison des jeunes gousses, stade sensible au stress hydrique.",
			},
			{
				id: "recolte",
				phase: "Étape 4",
				name: "Récolte des Gousses Tendres",
				period: "Jours 50 à 70",
				image: "/images/haricotvert/stage_recolte.png",
				fallbackUrl: "https://images.unsplash.com/photo-1567375698348-5d9d5ae99de0?auto=format&fit=crop&w=800&q=80",
				description: "Cueillette des gousses jeunes et tendres avant le développement des graines, refroidissement rapide après récolte.",
			},
		],
	},
	{
		...
		growthStages: [
			{
				id: "semis",
				phase: "Étape 1",
				name: "Plantation des Rejets",
				period: "Mois 1",
				image: "/images/banane/stage_semis.png",
				fallbackUrl: "https://images.unsplash.com/photo-1528825871115-3581a5387919?auto=format&fit=crop&w=800&q=80",
				description: "Mise en terre de rejets sains sur sol profond et riche, arrosage abondant pour sécuriser la reprise.",
			},
			{
				id: "floraison",
				phase: "Étape 2",
				name: "Floraison & Formation du Régime",
				period: "Mois 2 à 6",
				image: "/images/banane/stage_floraison.png",
				fallbackUrl: "https://images.unsplash.com/photo-1464226184884-fa280b87c399?auto=format&fit=crop&w=800&q=80",
				description: "Émergence de l'inflorescence et formation progressive des mains, nécessitant un apport constant en eau et en potasse.",
			},
			{
				id: "croissance",
				phase: "Étape 3",
				name: "Croissance Végétative",
				period: "Mois 7 à 9",
				image: "/images/banane/stage_croissance.png",
				fallbackUrl: "https://images.unsplash.com/photo-1500382017468-9049fed747ef?auto=format&fit=crop&w=800&q=80",
				description: "Développement vigoureux du pseudo-tronc et du feuillage, élimination des rejets excédentaires pour concentrer la vigueur.",
			},
			{
				id: "recolte",
				phase: "Étape 4",
				name: "Récolte du Régime",
				period: "Mois 9 à 12",
				image: "/images/banane/stage_recolte.png",
				fallbackUrl: "https://images.unsplash.com/photo-1528825871115-3581a5387919?auto=format&fit=crop&w=800&q=80",
				description: "Coupe du régime quand les doigts sont bien remplis mais encore verts, manipulation soigneuse jusqu'au mûrissement.",
			},
		],
	},
	{
		...
		growthStages: [
			{
				id: "semis",
				phase: "Étape 1",
				name: "Plantation du Jeune Plant",
				period: "Année 1",
				image: "/images/mangue/stage_semis.png",
				fallbackUrl: "https://images.unsplash.com/photo-1553279768-865429fa0078?auto=format&fit=crop&w=800&q=80",
				description: "Mise en terre d'un jeune manguier greffé sur sol profond et bien drainé, arrosage régulier pour sécuriser la reprise.",
			},
			{
				id: "croissance",
				phase: "Étape 2",
				name: "Croissance de l'Arbre",
				period: "Années 2 à 4",
				image: "/images/mangue/stage_croissance.png",
				fallbackUrl: "https://images.unsplash.com/photo-1500382017468-9049fed747ef?auto=format&fit=crop&w=800&q=80",
				description: "Développement de la charpente et du feuillage, tailles de formation pour aérer l'arbre et stimuler la future fructification.",
			},
			{
				id: "floraison",
				phase: "Étape 3",
				name: "Floraison & Nouaison",
				period: "Saison sèche (avant récolte)",
				image: "/images/mangue/stage_floraison.png",
				fallbackUrl: "https://images.unsplash.com/photo-1464226184884-fa280b87c399?auto=format&fit=crop&w=800&q=80",
				description: "Apparition des panicules florales puis formation des jeunes fruits, période sensible à l'anthracnose en cas d'humidité.",
			},
			{
				id: "recolte",
				phase: "Étape 4",
				name: "Récolte des Mangues",
				period: "Mars à Juillet selon variété",
				image: "/images/mangue/stage_recolte.png",
				fallbackUrl: "https://images.unsplash.com/photo-1553279768-865429fa0078?auto=format&fit=crop&w=800&q=80",
				description: "Cueillette à maturité physiologique avec le pédoncule, mise en caisses pour limiter les chocs avant conservation au frais.",
			},
		],
	},
	{
		...
		growthStages: [
			{
				id: "semis",
				phase: "Étape 1",
				name: "Pépinière & Plantation",
				period: "Mois 1",
				image: "/images/papaye/stage_semis.png",
				fallbackUrl: "https://images.unsplash.com/photo-1617112848923-cc2234396a8d?auto=format&fit=crop&w=800&q=80",
				description: "Semis en pépinière puis plantation des jeunes plants sur billons espacés de 2-3 m pour éviter l'engorgement d'eau.",
			},
			{
				id: "croissance",
				phase: "Étape 2",
				...
				period: "Mois 2 à 6",
				image: "/images/papaye/stage_croissance.png",
				fallbackUrl: "https://images.unsplash.com/photo-1500382017468-9049fed747ef?auto=format&fit=crop&w=800&q=80",
				description: "Développement rapide du tronc et du feuillage, apports NPK réguliers pour soutenir cette croissance exigeante en nutriments.",
			},
			{
				id: "floraison",
				phase: "Étape 3",
				name: "Floraison & Nouaison",
				period: "Mois 6 à 8",
				image: "/images/papaye/stage_floraison.png",
				fallbackUrl: "https://images.unsplash.com/photo-1464226184884-fa280b87c399?auto=format&fit=crop&w=800&q=80",
				description: "Apparition des fleurs puis formation des jeunes fruits le long du tronc, surveillance des virus transmis par pucerons.",
			},
			{
				id: "recolte",
				phase: "Étape 4",
				name: "Récolte Échelonnée",
				period: "Mois 8 à 10, puis en continu",
				image: "/images/papaye/stage_recolte.png",
				fallbackUrl: "https://images.unsplash.com/photo-1617112848923-cc2234396a8d?auto=format&fit=crop&w=800&q=80",
				description: "Cueillette dès que la peau jaunit à la base du fruit, manipulation délicate et conservation au frais pour prolonger la durée.",
			},
		],
	},
	{
		...
		growthStages: [
			{
				...
				name: "Semis Direct",
				period: "Jours 1 à 15",
				image: "/images/pasteque/stage_semis.png",
				fallbackUrl: "https://images.unsplash.com/photo-1587049352847-4a222e784d38?auto=format&fit=crop&w=800&q=80",
				description: "Semis en poquets sur sol sableux bien drainé, espacement large de 2 m pour anticiper le développement rampant.",
			},
			{
				id: "croissance",
				phase: "Étape 2",
				name: "Croissance des Lianes",
				period: "Jours 15 à 40",
				image: "/images/pasteque/stage_croissance.png",
				fallbackUrl: "https://images.unsplash.com/photo-1500382017468-9049fed747ef?auto=format&fit=crop&w=800&q=80",
				description: "Développement des tiges rampantes et du feuillage, paillage pour limiter le contact des futurs fruits avec le sol humide.",
			},
			{
				id: "floraison",
				phase: "Étape 3",
				name: "Floraison & Nouaison",
				period: "Jours 40 à 60",
				image: "/images/pasteque/stage_floraison.png",
				fallbackUrl: "https://images.unsplash.com/photo-1464226184884-fa280b87c399?auto=format&fit=crop&w=800&q=80",
				description: "Apparition des fleurs jaunes et formation des jeunes fruits, surveillance de l'oïdium en cas d'humidité excessive.",
			},
			{
				id: "recolte",
				phase: "Étape 4",
				name: "Maturité & Récolte",
				period: "Jours 60 à 100",
				image: "/images/pasteque/stage_recolte.png",
				fallbackUrl: "https://images.unsplash.com/photo-1587049352847-4a222e784d38?auto=format&fit=crop&w=800&q=80",
				description: "Récolte vérifiée au son creux et au dessèchement de la vrille, arrosage réduit en fin de cycle pour améliorer le sucre.",
			},
		],
	},
	{
		...
		growthStages: [
			{
				...
				name: "Semis en Poquets",
				period: "Juin - Juillet",
				image: "/images/niebe/stage_semis.png",
				fallbackUrl: "https://images.unsplash.com/photo-1540420773420-3366772f4999?auto=format&fit=crop&w=800&q=80",
				description: "Semis en poquets sur sol pauvre ou sableux, la culture s'adapte bien aux conditions difficiles du Sahel.",
			},
			{
				id: "croissance",
				phase: "Étape 2",
				name: "Croissance Végétative",
				period: "Semaines 3 à 6",
				image: "/images/niebe/stage_croissance.png",
				fallbackUrl: "https://images.unsplash.com/photo-1500382017468-9049fed747ef?auto=format&fit=crop&w=800&q=80",
				description: "Développement du feuillage et des tiges, bonne tolérance à la sécheresse grâce au système racinaire fixateur d'azote.",
			},
			{
				id: "floraison",
				phase: "Étape 3",
				name: "Floraison & Formation des Gousses",
				period: "Semaines 6 à 9",
				image: "/images/niebe/stage_floraison.png",
				fallbackUrl: "https://images.unsplash.com/photo-1464226184884-fa280b87c399?auto=format&fit=crop&w=800&q=80",
				description: "Floraison échelonnée suivie de la formation des gousses, surveillance des pucerons et de la punaise suceuse de gousses.",
			},
			{
				id: "recolte",
				phase: "Étape 4",
				name: "Récolte & Séchage",
				period: "Septembre - Octobre",
				image: "/images/niebe/stage_recolte.png",
				fallbackUrl: "https://images.unsplash.com/photo-1540420773420-3366772f4999?auto=format&fit=crop&w=800&q=80",
				description: "Récolte des gousses sèches et cassantes, séchage complet avant stockage et traitement contre la bruche.",
			},
		],
	},
];
