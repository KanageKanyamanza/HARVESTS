...
const Fleet = React.lazy(() => import('../../../pages/dashboard/transporter/Fleet'));
const AddVehicle = React.lazy(() => import('../../../pages/dashboard/transporter/AddVehicle'));
const EditVehicle = React.lazy(() => import('../../../pages/dashboard/transporter/EditVehicle'));
const Orders = React.lazy(() => import('../../../pages/dashboard/transporter/Orders'));
const Statistics = React.lazy(() => import('../../../pages/dashboard/transporter/Statistics'));
